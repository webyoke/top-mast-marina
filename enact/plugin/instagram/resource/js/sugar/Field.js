Enact.react_class.Fields.Instagram = React.createClass({
    ...
    render: function(){
        ...
        if(gram){
            gram = <div dangerouslySetInnerHTML={{ __html : gram }}/>;
        }//if

        return (
                <div>
                    <input type='text' defaultValue={this.state.field.value} onChange={this.onChange} placeholder='Paste Instagram URL...'/>
                    {gram}
                </div>
            );
